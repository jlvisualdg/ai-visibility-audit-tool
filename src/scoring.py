...
AI_ISM_PHRASES: list[str] = [
    # Hedging / meta-commentary filler common in LLM responses
    "key considerations",
    "it depends",
    "keep in mind",
    "it's worth noting",
    ...
    "pro tip",
    "quick tip",
    # Section-header phrases AI uses in comparison / list responses
    "top vendors",
    "top providers",
    "top options",
    "best options",
...
_DESCRIPTIVE_TERMS: set[str] = {
    # Healthcare / medical category descriptions (not brand names)
    ...
    # Generic comparison / evaluation labels
    "top picks", "top choices", "top options",
    "best picks", "best choices", "best options",
    "key features", "main benefits",
    "pro tip", "quick tip",
    "reviews summary", "key criteria",
    "contact information",
    "pricing breakdown", "pricing comparison",
    "cost comparison", "feature comparison",
    "side effects", "medical supervision",
    "clinical evidence", "research suggests",
    "studies show", "expert opinions",
    "user experiences", "customer experiences",
    "patient experiences",
    "success rates", "satisfaction rates",
    "market share", "industry leaders", "market leaders",
    "leading providers", "reputable providers",
    "certified providers", "licensed providers",
    "qualified providers", "experienced providers",
    "trusted providers",
    "monthly costs", "out-of-pocket expenses",
    "insurance coverage details", "prescription costs",
    "consultation fees", "follow-up costs",
    "shipping costs", "discount programs",
    "savings programs", "financial assistance",
...
def _is_not_descriptive(phrase: str) -> bool:
    ...
    descriptive_suffixes = [
        ...
        "programs", "options", "solutions", "services",
        "medication", "relief", "symptoms",
        "trials", "studies", "reviews", "support", "consultation",
        "comparison", "alternatives", "categories", "resources",
    ]
